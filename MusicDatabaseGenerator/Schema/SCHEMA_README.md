...
- `LastKnownPath`
  - Used to aid in matching in the [PlaylistTransferTool](https://github.com/JeffreyGaydos/music-database-generator/blob/main/PlaylistTransferTool/README.md) when a valid track in the database is not found
- `SurrogateKey`
